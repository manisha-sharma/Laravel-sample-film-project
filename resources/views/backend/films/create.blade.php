        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
					...
					@endif
                    <form method="POST" action="{{ route('backend.store') }}" aria-label="{{ __('Login') }}"  enctype="multipart/form-data">
                        @csrf
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" name="ticket_price" value="{{ old('ticket_price') }}">
                            </div>
                        </div>
						<div class="form-group row">
